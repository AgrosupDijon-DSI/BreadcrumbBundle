...
namespace Cnerta\BreadcrumbBundle\Tests\Renderer;

use Cnerta\BreadcrumbBundle\Renderer\ContainerAwareProvider;
...
class ContainerAwareProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $renderer = $this->getMock('Cnerta\BreadcrumbBundle\Renderer\RendererInterface');
