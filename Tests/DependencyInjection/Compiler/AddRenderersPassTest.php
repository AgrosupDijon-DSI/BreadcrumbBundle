...
namespace Cnerta\BreadcrumbBundle\Tests\DependencyInjection\Compiler;
...
class AddRenderersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcessWithEmptyAlias()
    {
        ...
        $containerBuilderMock->expects($this->once())
            ->method('findTaggedServiceIds')
            ->with($this->equalTo('cnerta_breadcrumb.renderer'))
    ...
    public function testProcessWithAlias()
    {
        ...
        $containerBuilderMock->expects($this->once())
            ...
            ->with($this->equalTo('cnerta_breadcrumb.renderer_provider'))
